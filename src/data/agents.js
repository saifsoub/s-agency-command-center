export const AGENTS = [
  { id: 'LX-01', codename: 'AETHER', location: 'DXB-HQ', status: 'ACTIVE', hr: 72, bpm: 68, load: 87, color: 'from-cyan-400 to-blue-500', glow: 'rgba(0, 240, 255, 0.5)' },
  { id: 'LX-07', codename: 'VEIL', location: 'AUH-NODE', status: 'ACTIVE', hr: 81, bpm: 74, load: 62, color: 'from-violet-400 to-purple-500', glow: 'rgba(167, 139, 250, 0.5)' },
  { id: 'LX-12', codename: 'NEXUS', location: 'SHJ-EDGE', status: 'ACTIVE', hr: 65, bpm: 59, load: 94, color: 'from-emerald-400 to-teal-500', glow: 'rgba(52, 211, 153, 0.5)' },
  { id: 'LX-03', codename: 'PHANTOM', location: 'RAK-OUT', status: 'IDLE', hr: 58, bpm: 52, load: 23, color: 'from-amber-400 to-orange-500', glow: 'rgba(251, 191, 36, 0.5)' },
  { id: 'LX-19', codename: 'CIPHER', location: 'FUJ-SECURE', status: 'ACTIVE', hr: 76, bpm: 71, load: 78, color: 'from-rose-400 to-pink-500', glow: 'rgba(244, 114, 182, 0.5)' },
  { id: 'LX-22', codename: 'ORACLE', location: 'DXB-CORE', status: 'ACTIVE', hr: 69, bpm: 64, load: 91, color: 'from-sky-400 to-indigo-500', glow: 'rgba(56, 189, 248, 0.5)' },
]
...
export const NAV_ITEMS = [
  ...
  { id: 'marketplace', label: 'ORB MARKET', icon: 'ShoppingBag' },
  { id: 'voice', label: 'VOICE · TEL', icon: 'Mic' },
]
